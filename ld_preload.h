...
ssize_t (*original_sendto)(int socket, const void *buffer, size_t length, int flags, const struct sockaddr *address,
                           socklen_t address_len);

ssize_t (*original_sendmsg)(int socket, const struct msghdr *msg, int flags);

ssize_t
(*original_recvfrom)(int socket, void *buf, size_t length, int flags, struct sockaddr *addr, socklen_t *addrlen);
