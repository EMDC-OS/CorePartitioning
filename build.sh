...
gcc -pthread -Wall -fPIC -shared -Wl,--no-as-needed -ldl -o CPART_SINGLE_DEBUG.so fdtable.c ipc.c ld_preload.c print.c affinity.c -D__FILEIO__ -DSINGLE -D__DEBUG_SYSCALL__ -D__DEBUG_SYSTHREAD__ -D__DEBUG_FDTABLE__ -D__DEBUG_POOL__
